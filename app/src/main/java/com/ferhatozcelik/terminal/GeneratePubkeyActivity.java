...
import com.ferhatozcelik.terminal.util.EntropyDialog;
import com.ferhatozcelik.terminal.util.EntropyView;
import com.ferhatozcelik.terminal.util.OnEntropyGatheredListener;
import com.ferhatozcelik.terminal.util.OnKeyGeneratedListener;
...
public class GeneratePubkeyActivity extends AppCompatActivity implements OnEntropyGatheredListener,
	...
	private void checkEntries() {
		...
		if (allowSave) {
			save.getBackground().setColorFilter(getResources().getColor(R.color.primary_dark), PorterDuff.Mode.SRC_IN);
			save.setTextColor(getResources().getColor(R.color.white));
		} else {
			save.getBackground().setColorFilter(null);
			save.setTextColor(getResources().getColor(R.color.primary_light));
		}
