...
import com.ferhatozcelik.terminal.service.BridgeDisconnectedListener;
import com.ferhatozcelik.terminal.service.PromptHelper;
import com.ferhatozcelik.terminal.service.TerminalBridge;
import com.ferhatozcelik.terminal.service.TerminalKeyListener;
import com.ferhatozcelik.terminal.service.TerminalManager;
import com.ferhatozcelik.terminal.util.PreferenceConstants;
import com.ferhatozcelik.terminal.util.TerminalViewPager;
...
public class ConsoleActivity extends AppCompatActivity implements BridgeDisconnectedListener {
	...
	private void onEmulatedKeyClicked(String key) {
	...
	public void onCreate(Bundle icicle) {
		...
		RecyclerView buttonsList = findViewById(R.id.buttonsList);
		...
		fastButtons.add(new FastButton("button_esc", "ESC" , null));
		fastButtons.add(new FastButton("button_tab", null , R.drawable.ic_keyboard_tab));
		fastButtons.add(new FastButton("button_up", null , R.drawable.ic_keyboard_arrow_up));
		fastButtons.add(new FastButton("button_down", null , R.drawable.ic_keyboard_arrow_down));
		fastButtons.add(new FastButton("button_left", null , R.drawable.ic_keyboard_arrow_left));
		fastButtons.add(new FastButton("button_right", null , R.drawable.ic_keyboard_arrow_right));
		fastButtons.add(new FastButton("button_home", "HOME" , null));
		fastButtons.add(new FastButton("button_end", "END" , null));
		fastButtons.add(new FastButton("button_pgup", "PGUP" , null));
		fastButtons.add(new FastButton("button_pgdn", "PGDN" , null));
		fastButtons.add(new FastButton("button_f1", "F1" , null));
		fastButtons.add(new FastButton("button_f2", "F2" , null));
		fastButtons.add(new FastButton("button_f3", "F3" , null));
		fastButtons.add(new FastButton("button_f4", "F4" , null));
		fastButtons.add(new FastButton("button_f5", "F5" , null));
		fastButtons.add(new FastButton("button_f6", "F6" , null));
		fastButtons.add(new FastButton("button_f7", "F7" , null));
		fastButtons.add(new FastButton("button_f8", "F8" , null));
		fastButtons.add(new FastButton("button_f9", "F9" , null));
		fastButtons.add(new FastButton("button_f10", "F10" , null));
		fastButtons.add(new FastButton("button_f11", "F11" , null));
		fastButtons.add(new FastButton("button_f12", "F12" , null));

		LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context);
		linearLayoutManager.setOrientation(RecyclerView.HORIZONTAL);
		linearLayoutManager.scrollToPosition(0);
		buttonsList.setLayoutManager(linearLayoutManager);

		ListClickListener listItemClickListenner = fastButton -> {
			onEmulatedKeyClicked(fastButton.getId());
		};
		...
		linearLayoutCommandsManager.scrollToPosition(0);
		commandsList.setLayoutManager(linearLayoutCommandsManager);

		ListClickListener listItemClickCommandsListenner = fastButton -> {
			onEmulatedKeyClicked(fastButton.getId());
		};

		FastButtonListAdapter customACommandsdapter = new FastButtonListAdapter(commandsButtons , context, listItemClickCommandsListenner);
		commandsList.setAdapter(customACommandsdapter);
