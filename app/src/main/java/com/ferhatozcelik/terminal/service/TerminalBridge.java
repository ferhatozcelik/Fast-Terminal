...
import com.ferhatozcelik.terminal.TerminalView;
...
import com.ferhatozcelik.terminal.tools.terminal.VDUDisplay;
...
public class TerminalBridge implements VDUDisplay {
	...
	/* (non-Javadoc)
	 * @see com.ferhatozcelik.terminal.tools.terminal.VDUDisplay#setColor(byte, byte, byte, byte)
	 */
	@Override
